...
* The proporportion of cases for which the logical vector is TRUE is `r count(problem_two_df, vec_logical = 'TRUE') / nrow(problem_two_df)`.
...
ggsave(problem_two_df, plot = last_plot()
